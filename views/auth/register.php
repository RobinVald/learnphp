...
<div class="container">
    <h1 class="is-size-2">Register</h1>
</div>
...
<div class="field">
  <label class="label" for="email">Password Confirm</label>
  <div class="control">
    <input class="input" type="password" placeholder="password" name="password_confirm" id="password">
  </div>
</div>
